...
const CurrentSong = ({ image, title, artists }) => {
    return (
        <div className={`flex items-center gap-5 relative overflow-hidden`}>
            <picture className={`w-16 h-16 bg-zinc-800 rounded-md shadow-lg overflow-hidden`}> <img src={image} alt={title} /></picture>
...
const VolumeControl = () => {
    ...
    return (
        <div className="flex justify-center gap-x-2 text-white">
            <button className="opacity-70 hover:opacity-70 transition" onClick={handleClickVolume}>
